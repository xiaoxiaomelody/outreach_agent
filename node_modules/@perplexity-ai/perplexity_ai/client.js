...
const async_1 = require("./resources/async/async.js");
...
class Perplexity {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('PERPLEXITY_BASE_URL'), apiKey = (0, env_1.readEnv)('PERPLEXITY_API_KEY'), ...opts } = {}) {
        _Perplexity_instances.add(this);
        _Perplexity_encoder.set(this, void 0);
        this.chat = new API.Chat(this);
        this.search = new API.Search(this);
        this.async = new API.Async(this);
        if (apiKey === undefined) {
            throw new Errors.PerplexityError("The PERPLEXITY_API_KEY environment variable is missing or empty; either provide it, or instantiate the Perplexity client with an apiKey option, like new Perplexity({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
        ...
        this.timeout = options.timeout ?? _a.DEFAULT_TIMEOUT /* 15 minutes */;
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('PERPLEXITY_LOG'), "process.env['PERPLEXITY_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Perplexity_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.PerplexityError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Perplexity_instances, "m", _Perplexity_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Perplexity_encoder, "f").call(this, { body, headers });
        }
    }
}
...
Perplexity.DEFAULT_TIMEOUT = 900000; // 15 minutes
Perplexity.PerplexityError = Errors.PerplexityError;
Perplexity.APIError = Errors.APIError;
Perplexity.APIConnectionError = Errors.APIConnectionError;
Perplexity.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Perplexity.APIUserAbortError = Errors.APIUserAbortError;
Perplexity.NotFoundError = Errors.NotFoundError;
Perplexity.ConflictError = Errors.ConflictError;
Perplexity.RateLimitError = Errors.RateLimitError;
Perplexity.BadRequestError = Errors.BadRequestError;
Perplexity.AuthenticationError = Errors.AuthenticationError;
Perplexity.InternalServerError = Errors.InternalServerError;
Perplexity.PermissionDeniedError = Errors.PermissionDeniedError;
Perplexity.UnprocessableEntityError = Errors.UnprocessableEntityError;
Perplexity.toFile = Uploads.toFile;
Perplexity.Chat = chat_1.Chat;
Perplexity.Search = search_1.Search;
Perplexity.Async = async_1.Async;
