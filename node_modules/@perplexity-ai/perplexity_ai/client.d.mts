...
import { Search, SearchCreateParams, SearchCreateResponse } from "./resources/search.mjs";
import { Async } from "./resources/async/async.mjs";
import { Chat, StreamChunk } from "./resources/chat/chat.mjs";
 ...
 */
export declare class Perplexity {
    #private;
    apiKey: string;
    baseURL: string;
    maxRetries: number;
    ...
    private buildBody;
    static Perplexity: typeof Perplexity;
    static DEFAULT_TIMEOUT: number;
    static PerplexityError: typeof Errors.PerplexityError;
...
export declare namespace Perplexity {
    ...
    export { Search as Search, type SearchCreateResponse as SearchCreateResponse, type SearchCreateParams as SearchCreateParams, };
